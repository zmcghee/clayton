...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilmLog.release_year'
        db.add_column('movies_filmlog', 'release_year', self.gf('django.db.models.fields.PositiveIntegerField')(default=2010), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FilmLog.release_year'
        db.delete_column('movies_filmlog', 'release_year')


    models = {
        'movies.filmlog': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'FilmLog'},
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 12, 3, 21, 50, 10, 389382)'}),
